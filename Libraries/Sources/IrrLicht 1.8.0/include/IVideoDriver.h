	...
	*/
	...
	public:
		...
		*/
		...
		//! Draws a 3d polygon.
		/** Implemented by O.Shahbazi
		For some implementations, this method simply calls
		draw3Dline for some lines.
		Note that the line is drawn using the current transformation
		matrix and material. So if you need to draw the 3D line
		independently of the current transformation, use
		\code
		...
		for some properly set up material before drawing the line.
		Some drivers support line thickness set in the material.
		\param center Center of the 3d polygon.
		\param radius Radius of the 3d polygon.
		\param vertexCount Count edges in a polygon.
		\param color Color of the polygon.
		\param drawNormal Draw normal of the polygon.
		\param normal Normal of the polygon. */
		virtual void draw3DPolygon(const core::vector3d<f32> &center, double radius, u32 vertexCount, core::vector3d<f32> &normal, video::SColor color = video::SColor(255, 255, 255, 255), bool drawNormal = false) = 0;
