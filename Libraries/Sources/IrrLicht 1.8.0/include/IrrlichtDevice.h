	...
	*/
	...
	public:
		...
		*/
		...
		\return Pointer to created scene manager. */
		virtual scene::ISceneManager *createSceneManager(void) = 0;

		//! Destorys a scene manager.
		/** Implemented by O.Shahbazi
		\param SceneManager: SceneManager to destroy.*/
		virtual void destroySceneManager(scene::ISceneManager *SceneManager) = 0;

		//! Provides access to the scene manager.
		/** Implemented by O.Shahbazi
		\param Index: Index of SceneManager in list of scene managers.
		\return Pointer to the scene manager. */
		virtual scene::ISceneManager *getSceneManager(const unsigned int &Index) = 0;
