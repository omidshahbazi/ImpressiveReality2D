...
CIrrDeviceStub::~CIrrDeviceStub()
{
	...
	//if (SceneManager)
	//	SceneManager->drop();
	for(scene::ISceneManager *sm : m_SceneManagers)
		sm->drop();
...
void CIrrDeviceStub::createGUIAndScene()
{
	...
	//m_SceneManagers.push_back(scene::createSceneManager(VideoDriver, FileSystem, CursorControl, GUIEnvironment));
...
//! returns created scene manager
scene::ISceneManager *CIrrDeviceStub::createSceneManager(void)
{
	scene::CSceneManager* manager = new scene::CSceneManager(VideoDriver, FileSystem, CursorControl, NULL, GUIEnvironment);
...
void CIrrDeviceStub::destroySceneManager(scene::ISceneManager *SceneManager)
{
	m_SceneManagers.erase(std::find(m_SceneManagers.begin(), m_SceneManagers.end(), SceneManager));
...
scene::ISceneManager *CIrrDeviceStub::getSceneManager(const unsigned int &Index)
{
	//return SceneManager;
	return m_SceneManagers[Index];
}
