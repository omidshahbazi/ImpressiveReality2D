...
namespace irr
{
	...
	namespace scene
	{
		...
		typedef std::vector<ISceneManager*> SceneManagersVector;
	}
	...
	public:
		...
		scene::ISceneManager *createSceneManager(void);

		//! Destorys a scene manager.
		void destroySceneManager(scene::ISceneManager *SceneManager);

		//! returns the scene manager
		virtual scene::ISceneManager *getSceneManager(const unsigned int &Index);
	...
	protected:
		...
		scene::SceneManagersVector m_SceneManagers;
		ITimer* Timer;
