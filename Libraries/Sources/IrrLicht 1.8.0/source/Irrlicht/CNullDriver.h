...
namespace video
{
	...
	public:
		...
		//! Draws a 3d polygon.
		virtual void draw3DPolygon(const core::vector3d<f32> &center, 
			double radius, u32 vertexCount, core::vector3d<f32> &normal, video::SColor color = video::SColor(255, 255, 255, 255), bool drawNormal = false);
