...
public:
	ApplyForce()
	{
		...
		const b2_float32 k_restitution = 0.4f;
...

		{
			...
			for (int i = 0; i < 10; ++i)
			{
				...
				b2_float32 gravity = 10.0f;
				b2_float32 I = body->GetInertia();
				b2_float32 mass = body->GetMass();

				// For a circle: I = 0.5 * m * r * r ==> r = sqrt(2 * I / m)
				b2_float32 radius = b2Sqrt(2.0f * I / mass);
