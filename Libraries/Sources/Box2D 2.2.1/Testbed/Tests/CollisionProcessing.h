...
public:
	CollisionProcessing()
	{
		...
		b2_float32 xLo = -5.0f, xHi = 5.0f;
		b2_float32 yLo = 2.0f, yHi = 35.0f;
	...
	void Step(Settings* settings)
	{
		...
		const b2_int32 k_maxNuke = 6;
		b2Body* nuke[k_maxNuke];
		b2_int32 nukeCount = 0;
		...
		for (b2_int32 i = 0; i < m_pointCount; ++i)
		{
			...
			b2_float32 mass1 = body1->GetMass();
			b2_float32 mass2 = body2->GetMass();
