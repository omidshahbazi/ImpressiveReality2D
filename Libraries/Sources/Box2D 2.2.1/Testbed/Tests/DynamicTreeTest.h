...
public:
	...
	DynamicTreeTest()
	{
		...
		for (b2_int32 i = 0; i < e_actorCount; ++i)
		{
	...
	void Step(Settings* settings)
	{
		...
		if (m_automated == true)
		{
			b2_int32 actionCount = b2Max(1, e_actorCount >> 2);

			for (b2_int32 i = 0; i < actionCount; ++i)
			{
				Action();
			}
		}
		...
		{
			b2_int32 height = m_tree.GetHeight();
...
private:
	...
	b2_float32 m_worldExtent;
	b2_float32 m_proxyExtent;
