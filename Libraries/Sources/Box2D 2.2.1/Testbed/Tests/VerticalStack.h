...
public:
	...
	VerticalStack()
	{
		...
		b2_float32 xs[5] = {0.0f, -10.0f, -5.0f, 5.0f, 10.0f};

		for (b2_int32 j = 0; j < e_columnCount; ++j)
		{
			...
			for (int i = 0; i < e_rowCount; ++i)
			{
				...
				b2_int32 n = j * e_rowCount + i;
				b2Assert(n < e_rowCount * e_columnCount);
				m_indices[n] = n;
				bd.userData = m_indices + n;

				b2_float32 x = 0.0f;
				//b2_float32 x = RandomFloat(-0.02f, 0.02f);
				//b2_float32 x = i % 2 == 0 ? -0.025f : 0.025f;
	...
	b2_int32 m_indices[e_rowCount * e_columnCount];
};
