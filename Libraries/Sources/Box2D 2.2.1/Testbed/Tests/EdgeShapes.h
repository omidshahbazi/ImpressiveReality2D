...
public:
	...
	EdgeShapes()
	{
		// Ground body
		{
			...
			b2_float32 x1 = -20.0f;
			b2_float32 y1 = 2.0f * cosf(x1 / 10.0f * b2_pi);
			for (b2_int32 i = 0; i < 80; ++i)
			{
				b2_float32 x2 = x1 + 0.5f;
				b2_float32 y2 = 2.0f * cosf(x2 / 10.0f * b2_pi);
	...
	void Create(b2_int32 index)
	{
		...
		b2_float32 y = RandomFloat(10.0f, 20.0f);
		bd.position.Set(x, y);
