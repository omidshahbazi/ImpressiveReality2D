...
public:
	...
	void Launch()
	{
		...
		extern b2_int32 b2_gjkCalls, b2_gjkIters, b2_gjkMaxIters;
		extern b2_int32 b2_toiCalls, b2_toiIters, b2_toiMaxIters;
		extern b2_int32 b2_toiRootIters, b2_toiMaxRootIters;
	...
	void Step(Settings* settings)
	{
		...
		extern b2_int32 b2_gjkCalls, b2_gjkIters, b2_gjkMaxIters;
		extern b2_int32 b2_toiCalls, b2_toiIters;
		extern b2_int32 b2_toiRootIters, b2_toiMaxRootIters;

		if (b2_gjkCalls > 0)
		{
			m_debugDraw.DrawString(5, m_textLine, "gjk calls = %d, ave gjk iters = %3.1f, max gjk iters = %d",
				b2_gjkCalls, b2_gjkIters / b2_float32(b2_gjkCalls), b2_gjkMaxIters);
			m_textLine += 15;
		}
		...
		if (b2_toiCalls > 0)
		{
			m_debugDraw.DrawString(5, m_textLine, "toi calls = %d, ave toi iters = %3.1f, max toi iters = %d",
				b2_toiCalls, b2_toiIters / b2_float32(b2_toiCalls), b2_toiMaxRootIters);
			m_textLine += 15;

			m_debugDraw.DrawString(5, m_textLine, "ave toi root iters = %3.1f, max toi root iters = %d",
				b2_toiRootIters / b2_float32(b2_toiCalls), b2_toiMaxRootIters);
			m_textLine += 15;
		}
