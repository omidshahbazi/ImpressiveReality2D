...
public:
	...
	void Step(Settings* settings)
	{
		...
		extern b2_int32 b2_toiMaxIters, b2_toiMaxRootIters;
		...
		for (b2_int32 i = 0; i < m_shapeA.m_vertexCount; ++i)
		{
		...
		b2_float32 wB = sweepB.a - sweepB.a0;
		b2Vec2 vB = sweepB.c - sweepB.c0;
		b2Vec2 v = vB + b2Cross(wB, rB);

		for (b2_int32 i = 0; i < m_shapeB.m_vertexCount; ++i)
		{
...
#if 0
		for (b2_float32 t = 0.0f; t < 1.0f; t += 0.1f)
		{
